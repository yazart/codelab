...
export class RemoteSelection {
   ...
   * @internal
   */
  private static _swapIfNeeded(start: monaco.IPosition, end: monaco.IPosition): { start: monaco.IPosition, end: monaco.IPosition } {
   ...
   * @internal
   */
  private _startPosition: monaco.IPosition = {lineNumber: 0, column:0};

  /**
   * The current end position of the selection.
   * @internal
   */
  private _endPosition: monaco.IPosition = {lineNumber: 0, column:0};
   ...
   */
  public getStartPosition(): monaco.IPosition {
   ...
   *   The start position of the selection.
   */
  public getEndPosition(): monaco.IPosition {
   ...
   */
  public setPositions(start: monaco.IPosition, end: monaco.IPosition): void {
