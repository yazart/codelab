...
function getConfiguration(editorInstance: monaco.editor.ICodeEditor): IConfiguration {
 ...
 * @internal
 */
export class RemoteCursorWidget implements monaco.editor.IContentWidget, monaco.IDisposable {
  ...
  private _position: monaco.editor.IContentWidgetPosition | null | undefined;
  private _offset: number;
  private _hideTimer: any;
  private _disposed: boolean;

  constructor(codeEditor: monaco.editor.ICodeEditor,
              widgetId: string,
